...
:- dynamic
	...
	event/1, waitingForStartButton/0, waitingForEvent/1.
	
waiting :- waitingForEvent('ListeningDone').
waiting :- waitingForEvent('PlayAudioDone').
waiting :- waitingForEvent('TextDone').
% special handling of START button on first screen
waiting :- waitingForStartButton.
